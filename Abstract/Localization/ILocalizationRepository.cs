...
namespace AspNetCore2Angular5.Abstract.Localization
{
    public interface ILocalizationRepository : IDisposable
    {
        Task<IList<IEntityType>> GetEntityList();
        ...
        Task<ICollection<PropertyData>> GetPropertyValueForAttribute(string fullQualifiedName, string properties);
        /// <summary>
